"""SUBHUNT core — Aggregate & dedupe subdomain enumeration from multiple sources."""
...
RULES = [
    ("SUB-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("SUB-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("SUB-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
