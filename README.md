...
[![PyPI](https://img.shields.io/pypi/v/cognis-subhunt.svg)](https://pypi.org/project/cognis-subhunt/)
[![CI](https://github.com/cognis-digital/subhunt/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/subhunt/actions)
...
SUBHUNT exists for one job — aggregate & dedupe subdomain enumeration from multiple sources — and does it without a SaaS bill or heavyweight setup.
...
```bash
subhunt --version
subhunt scan .                      # scan the current project
subhunt scan . --format json
subhunt scan . --fail-on high       # non-zero exit for CI gates
subhunt mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **amass/subfinder**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`subhunt` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
