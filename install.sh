#!/usr/bin/env sh
# Universal installer for subhunt. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/subhunt.git"
echo "Installing subhunt ..."
